...
export const organizationsStore: Organizations = {
		...
		organizers: [
			{
				...
				links: [{ twitter: 'https://twitter.com/dgaspard' }, { linkedin: 'https://www.linkedin.com/in/dustin-gaspard' }, { website: 'http://www.diamonddata.com/' }, { email: 'dgaspard@gmail.com' }]
			},
			{
				name: 'Garett Majoue',
		...
		organizers: [
			{
				...
				links: [{ github: 'https://github.com/bhelx' }, { linkedin: 'https://www.linkedin.com/in/benjamin-eckel-b025831a3/' }, { email: 'bhelx@simst.im' }]
			},
			{
				name: 'Aaron Lee',
				pfp: '/organizersPfp/aaron.webp',
				links: [{ github: 'https://github.com/wwkeyboard' }]
			}
		],
		...
		organizers: [
			{
				name: 'Kenny',
				pfp: '/organizersPfp/egg.webp',
				links: [{ website: 'https://www.brssug.org/' }, { email: 'sqlpassbr@gmail.com' }, { twitter: 'http://www.twitter.com/BRSSUG/' }]
			}
		],
		...
		organizers: [
			{
				...
				links: [{ linkedin: 'https://www.linkedin.com/in/loganhochwald/' }, { email: 'loganhochwald@gmail.com' }, { github: 'https://github.com/loganhochwald' }]
			},
			{
				name: 'Rene Mercadel',
				pfp: '/organizersPfp/rene.webp',
				links: [{ linkedin: 'https://www.linkedin.com/in/rene-mercadel-76718423a' }, { email: 'renemercadel@gmail.com' }]
			}
		],
		...
		organizers: [
			{
				...
				links: [{ github: 'https://github.com/colinwilliams91' }, { linkedin: 'https://www.linkedin.com/in/colin-williams-dev' }, { website: 'https://www.colin-williams.dev/' }, { email: 'colin.williams.dev@gmail.com' }]
			},
			{
				name: 'Jorge Carvajal',
				pfp: '/organizersPfp/jorge.webp',
				links: [{ github: 'https://github.com/codingMustache' }, { linkedin: 'https://github.com/codingMustache' }, { website: 'https://codingmustache.dev' }, { email: 'contact@codingmustache.dev' }]
			}
		],
		...
		organizers: [
			{
				...
				links: [{ website: 'http://neworleansgamedev.com' }, { email: 'contact@neworleansgamedev.com' }]
			},
			{
				name: 'Curtis',
				pfp: '/organizersPfp/curtis.webp',
				links: [{ website: 'http://neworleansgamedev.com' }, { email: 'contact@neworleansgamedev.com' }]
			},
			{
				name: 'Chris Morrison',
				pfp: '/organizersPfp/chrisMorrison.webp',
				links: [{ website: 'http://neworleansgamedev.com' }, { email: 'contact@neworleansgamedev.com' }]
			}
		],
		calendar_id: 'd2ce13d5608aebe0ff7d3bcec5ea581fea8ca24d66e5f65c112e8cc3dabdbec1@group.calendar.google.com',
		...
		organizers: [
			{
				...
				links: [{ linkedin: 'https://www.linkedin.com/in/james-guenther-37797745/' }, { website: 'https://twitter.com/startupgrindno' }, { email: 'jguenther@startupgrind.com' }]
			}
		],
		...
		organizers: [
			{
				...
				links: [{ linkedin: 'https://www.linkedin.com/in/brookbissinger/' }, { twitter: 'https://twitter.com/brook5280' }]
			}
		],
	...
	'NOLA-Womxn-in-Tech': {
		...
		about: 'Connecting those who identify as women within the Greater New Orleans tech ecosystem. Mostly social (for now)!',
	...
	'StartUp-Nola-Now': {
		...
		calendar_id: '22u5m29t5c2r61m2j3gjhe1kas@group.calendar.google.com',
